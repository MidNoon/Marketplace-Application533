        ...
        ResetPasswordSendEmailButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                if (TextUtils.isEmpty(userEmail)){
                    Toast.makeText(ResetPasswordActivity.this,"Please your correct email", Toast.LENGTH_SHORT).show();
                    ...
                    mAuth.sendPasswordResetEmail(userEmail).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            {
                                Toast.makeText(ResetPasswordActivity.this,"Please check you email Account, to reset password", Toast.LENGTH_SHORT).show();
